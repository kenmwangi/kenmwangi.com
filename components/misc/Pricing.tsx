...
export default function Pricing() {
  return (
    <section className="relative w-full bg-gradient-to-br from-zinc-50 via-white to-zince-100 py-16 dark:from-zinc-900 dark:via-zinc-950 dark:to-black md:py-32">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-[10%] left-[50%] h-[40%] w-[60%] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"></div>
        <div className="absolute -bottom-[10%] -right-[10%] h-[40%] w-[40%] rounded-full bg-primary/5 blur-3xl"></div>
