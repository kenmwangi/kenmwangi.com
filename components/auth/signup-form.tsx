...
export default function SignUpForm() {
  return (
    <section className="rose-gradient relative min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative z-10 grid min-h-screen grid-cols-1">
        <motion.div
          ...
          >
            <Card className="w-full max-w-md border-border/70 bg-card/20 shadow-[0_10px_26px_#e0e0e0a1] backdrop-blur-lg dark:shadow-none">
              <CardContent className="space-y-6 p-8">
                ...
                {/* Terms */}
                <motion.div className="mt-2 text-center text-xs text-muted-foreground">
