...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16 py-8 lg:py-0">
        <header
          id="intro"
          ref={(el) => {
        ...
        >
          <div className="grid lg:grid-cols-5 gap-12 sm:gap-16 w-full">
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-4 sm:space-y-3 mt-4">
                <div className="text-sm text-muted-foreground font-mono tracking-wider mb-8">
                  PORTFOLIO // 2025
                </div>
              ...
              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-foreground">Golang</span>,{" "}
                  <span className="text-foreground">Docker</span>, and{" "}
                  <span className="text-foreground">Kubernetes</span>. I design
                  and build{" "}
                  <span className="text-foreground">
                    scalable microservices
                  </span>{" "}
                  and{" "}
                  <span className="text-foreground">cloud-native systems</span>{" "}
                  powering Africa&apos;s real estate technology and beyond.
                </p>
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="w-32 h-32 relative lg:mx-0">
                <Image
                  src="/ken-mwangi.jpeg"
                  alt="Ken Mwangi"
                  fill
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-foreground">Backend Engineer</div>
              ...
              {[
                {
                  ...
                  url: "https://www.african-realestate.com", // ✅ link
                  description:
                    "Leading full-stack architecture for real estate platform and maintaining a leading platform for properties listings.",
                  tech: [
                    "AWS",
                    "Docker",
                    "Python",
                ...
                },
                {
                  ...
                  company: "Kasuku Tech",
                  url: "https://www.kasukutech.com", // ✅ link
                  description:
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  ...
                  conversations about technology and making impact.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <span className="text-base sm:text-lg">{contactEmail}</span>
                    <svg
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
            <div className="space-y-2">
              <div className="text-sm text-muted-foreground">
                &copy; {new Date().getFullYear()} Ken Mwangi. All rights
                reserved.
              </div>
            </div>
